...
public class SendLocationHttpTask extends AsyncTask<String, String, String> {
	...
	protected String doInBackground(String... params) {
		...
		try {
			...
			nameValuePairs.add(new BasicNameValuePair("server_id", params[1]));
	...
	protected void onPostExecute(String result) {
	    ...
	    delegate.processSendLocationFinish();		
	}
}
